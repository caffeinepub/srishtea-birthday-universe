...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = o.useState(null), [lt, J] = o.useState(null), [W, H] = o.useState(false), [A, mt] = o.useState(false), [L, z2] = o.useState(false), [ct, d] = o.useState(false), [h, y] = o.useState(false), [R, j] = o.useState(0), [p, _] = o.useState(0), O = o.useRef(t.duration || X || Wt), G = o.useRef(null), k = o.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = o.useMemo(() => S.findIndex((r) => r.toastId === t.id) || 0, [S, t.id]), Jt = o.useMemo(() => {
    var r;
    return (r = t.closeButton) != null ? r : et;
  }, [t.closeButton, et]), Tt = o.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = o.useRef(0), U2 = o.useRef(0), St = o.useRef(0), K = o.useRef(null), [Gt, Qt] = st.split("-"), Rt = o.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      style: {
        padding: "5rem 1.5rem",
        textAlign: "center",
        background: "linear-gradient(160deg, rgba(100,40,10,0.25), rgba(160,60,20,0.15), rgba(238,38,137,0.1))",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "for all the chai conversations we haven't had yet ☕"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                ...
                style: {
                  ...
                  filter: clicked ? "drop-shadow(0 0 20px rgba(238,38,137,0.7))" : "drop-shadow(0 0 8px rgba(238,100,30,0.4))"
                },
                onMouseEnter: (e) => {
        ...
        clicked && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              padding: "1.8rem 2rem",
              borderRadius: "1.2rem",
              background: "linear-gradient(135deg, rgba(160,60,20,0.3), rgba(238,38,137,0.2))",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "someday soon. a cup of chai. just us."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "1.5rem", marginTop: "0.8rem" }, children: "☕🌸" })
            ]
          }
        )
      ]
...
function Confetti({ trigger, count = 60 }) {
  ...
  reactExports.useEffect(() => {
    ...
    setParticles(items);
    const timer = setTimeout(() => setParticles([]), 4e3);
...
function CrystalBallSection({ onSecretFound }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => {
              onSecretFound(3);
              ue("✨ secret twin lore discovered", {
                style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "Consult the Crystal Ball 🔮"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "ask the universe what it holds"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
        ...
        revealed && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              borderRadius: "1.2rem",
              padding: "1.8rem 2rem",
              background: "linear-gradient(135deg, rgba(3,81,163,0.3), rgba(238,38,137,0.2))",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: '"this year gonna bring u all the happiness, good chaos and sweet memories and yea u gonna pass the accounts exam (i hope to see it all happening)"'
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "tap again to reset"
                }
              )
            ]
          }
        ),
        !revealed && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(199,182,255,0.7)", fontSize: "0.9rem" }, children: "tap the crystal to see your reading" })
      ]
    }
  );
}
...
const SPARKLE_DATA = [
  { id: "sp-0", left: 15, top: 10, size: 0.6, delay: 0.5, dur: 2, sym: "✨" },
  ...
  { id: "sp-6", left: 60, top: 45, size: 1, delay: 0.3, dur: 2.6, sym: "⭐" },
  { id: "sp-7", left: 25, top: 90, size: 0.7, delay: 2.5, dur: 2, sym: "✦" },
  { id: "sp-8", left: 90, top: 25, size: 0.9, delay: 1.1, dur: 3, sym: "★" },
  ...
  { id: "sp-18", left: 68, top: 10, size: 0.7, delay: 0.7, dur: 2, sym: "★" },
  {
    id: "sp-19",
    left: 95,
    top: 45,
...
function FinalEnding() {
  ...
  const [visibleLines, setVisibleLines] = reactExports.useState(/* @__PURE__ */ new Set());
  ...
  const [lastClickTime, setLastClickTime] = reactExports.useState(0);
  const [showBonus, setShowBonus] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    if (!started) return;
    const timers = LINES.map(
      (line, i) => setTimeout(() => {
        setVisibleLines((prev) => /* @__PURE__ */ new Set([...prev, i]));
      }, line.delay)
    );
    const btnTimer = setTimeout(() => setShowButton(true), 4e3);
    return () => {
  ...
  const handleHappyBirthdayClick = () => {
    const now2 = Date.now();
    const newCount = now2 - lastClickTime < 2e3 ? clickCount + 1 : 1;
    setClickCount(newCount);
    setLastClickTime(now2);
    if (newCount >= 3) {
      setShowBonus(true);
      setClickCount(0);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        ...
        padding: "5rem 1.5rem",
        background: "linear-gradient(160deg, rgba(5,5,20,0.97) 0%, rgba(15,8,40,0.97) 50%, rgba(20,5,30,0.97) 100%)",
        textAlign: "center",
        position: "relative",
        overflow: "hidden"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Confetti, { trigger: confettiTrigger, count: 80 }),
        SPARKLE_DATA.map((sp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: "700px", zIndex: 1 }, children: [
          LINES.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
                fontSize: line.bold ? "clamp(1.8rem, 6vw, 3rem)" : "clamp(1rem, 3vw, 1.4rem)",
                fontFamily: "'Playfair Display', serif",
                fontStyle: line.bold ? "normal" : "italic",
                fontWeight: line.bold ? 800 : 400,
                color: line.bold ? "transparent" : "rgba(245,242,255,0.85)",
                background: line.bold ? "linear-gradient(135deg, #EE2689, #0351A3)" : "none",
                WebkitBackgroundClip: line.bold ? "text" : void 0,
                backgroundClip: line.bold ? "text" : void 0,
                WebkitTextFillColor: line.bold ? "transparent" : void 0,
                ...
                filter: line.bold ? "drop-shadow(0 0 20px rgba(238,38,137,0.5))" : "none"
              },
              children: line.text
            },
            line.id
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(160deg, rgba(20,10,50,0.97), rgba(30,5,40,0.97))",
                  ...
                  boxShadow: "0 0 60px rgba(238,38,137,0.3), 0 0 120px rgba(3,81,163,0.2)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        "It's rare to find someone you can be stupid, dramatic and real with.",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        "You make normal days interesting just by existing.",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        "I hope 18 treats you well.",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                        "Even if it doesn't… you'll handle it with chaos and style."
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: "Happy Birthday Twin ✨"
                          }
                        ),
                        clickCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
                              fontSize: "0.7rem",
                            ...
                            children: clickCount === 1 ? "2 more..." : "1 more..."
                          }
                        )
                      ]
                    }
        ...
        showBonus && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(160deg, rgba(238,38,137,0.25), rgba(3,81,163,0.3))",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "bonus message unlocked:"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "thanks for being my safe chaos."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.5rem", marginBottom: "1.5rem" }, children: "✨🎀✨" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
...
function FlipCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      onClick: handleFlip,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flip-card-inner ${flipped ? "is-flipped" : ""}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flip-card-front", children: front }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flip-card-back", children: back })
      ] })
    }
  );
}
const CARDS$1 = [
  {
    ...
    name: "The Fool",
    symbol: "🌼",
    message: "Boundless curiosity. Someone who leaps before they look — not out of stupidity, but out of trust."
  },
  {
    id: "star",
    name: "The Star",
    symbol: "🌟",
    message: "Hope and light in the dark. The one who makes things feel possible just by being there."
  },
  {
    id: "magician",
    name: "The Magician",
    symbol: "✨",
    message: "Turns nothing into something. Has all the tools, always finds a way."
  }
];
function FriendshipTarot() {
  const [flippedCount, setFlippedCount] = reactExports.useState(0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "Secret Friendship Tarot ✨"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: CARDS$1.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              FlipCard,
              {
                height: "360px",
                onFlip: () => setFlippedCount((c) => c + 1),
                front: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      height: "100%",
                      ...
                      alignItems: "center",
                      justifyContent: "center",
                      background: "linear-gradient(160deg, rgba(30,35,70,0.7), rgba(58,42,138,0.8))",
                      border: "1px solid rgba(199,182,255,0.3)",
                      gap: "1rem",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "tap to draw"
                        }
                      )
                    ]
                  }
                ),
                back: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      height: "100%",
                      ...
                      justifyContent: "center",
                      padding: "1.5rem",
                      background: "linear-gradient(160deg, rgba(238,38,137,0.25), rgba(3,81,163,0.35))",
                      border: "1px solid rgba(238,38,137,0.4)",
                      gap: "0.8rem",
                      backdropFilter: "blur(12px)",
                      textAlign: "center"
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "2.2rem" }, children: card.symbol }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                          className: "font-serif",
        ...
        flippedCount >= 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "animate-reveal-up",
            style: {
              ...
              padding: "2.5rem",
              borderRadius: "1.5rem",
              background: "linear-gradient(160deg, rgba(238,38,137,0.2), rgba(3,81,163,0.25))",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "All three cards were the same person."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Some people are temporary chapters. Some become part of the story."
                }
              )
            ]
          }
...
function LandingSection({ onEnter, onSecretFound }) {
  const [showHao, setShowHao] = reactExports.useState(false);
  const [flipping, setFlipping] = reactExports.useState(false);
  const [bowEgg, setBowEgg] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const t = setTimeout(() => setShowHao(true), 3e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        inset: 0,
        zIndex: 1e3,
        background: "linear-gradient(160deg, #0351A3 0%, #3a2a8a 40%, #9b2a7a 70%, #EE2689 100%)",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        overflow: "hidden"
      ...
      children: [
        NON_SECRET_FLOATERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: "Happy 18th Birthday Srishtea ✨"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Twin, welcome to level 18"
                }
              ),
              showHao && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    fontWeight: 600,
                    cursor: "pointer",
                    boxShadow: "0 0 24px rgba(238,38,137,0.5), 0 4px 20px rgba(0,0,0,0.3)",
                    transition: "transform 0.2s, box-shadow 0.2s",
                    letterSpacing: "0.02em"
                  },
                  onMouseEnter: (e) => {
                    e.currentTarget.style.transform = "translateY(-3px) scale(1.04)";
                    e.currentTarget.style.boxShadow = "0 0 36px rgba(238,38,137,0.7), 0 8px 30px rgba(0,0,0,0.3)";
                  },
                  onMouseLeave: (e) => {
                    e.currentTarget.style.transform = "";
                    e.currentTarget.style.boxShadow = "0 0 24px rgba(238,38,137,0.5), 0 4px 20px rgba(0,0,0,0.3)";
                  },
                  children: "Enter your birthday universe ✨"
                }
              )
            ]
          }
        ),
        bowEgg && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "animate-scale-in",
            style: {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "secret twin message unlocked"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
...
— idk`;
function LetterSection({ onSecretFound }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "A Letter, Just for You"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: { color: "#C7B6FF", fontStyle: "italic", marginBottom: "3rem" },
            children: "sealed with love and questionable decisions"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              borderRadius: "1.5rem",
              padding: "2.5rem 2rem",
              background: "linear-gradient(160deg, rgba(245,242,255,0.15), rgba(3,81,163,0.15))",
            ...
            children: [
              ...
              !opened ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "4rem", marginBottom: "1rem" }, children: "✉️" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
                  {
                    className: "font-serif",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.85rem", color: "#C7B6FF" }, children: "(hao verification required)" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-reveal-up", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", marginBottom: "1.5rem" }, children: "✉️ ✨" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "pre",
                  {
                    style: {
...
const MOVIES = [
  {
    ...
    year: "1989",
    emoji: "📚",
    gradient: "linear-gradient(160deg, rgba(20,20,40,0.85), rgba(3,81,163,0.4))",
  ...
  },
  {
    ...
    year: "2005",
    emoji: "💜",
    gradient: "linear-gradient(160deg, rgba(30,10,50,0.85), rgba(130,0,100,0.4))",
...
function MovieSection({ onSecretFound }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      style: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3.5rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              className: "font-serif gradient-text",
              ...
              children: "Films for a Main Character Era 🎬"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#C7B6FF", fontStyle: "italic" }, children: "tap to reveal the message" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: MOVIES.map((movie) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              FlipCard,
              {
                height: "340px",
                front: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "3rem" }, children: movie.emoji }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                          className: "font-serif",
                ...
                back: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      ...
                      justifyContent: "center",
                      padding: "2rem 1.5rem",
                      background: "linear-gradient(160deg, rgba(238,38,137,0.3), rgba(3,81,163,0.35))",
                      border: "1px solid rgba(238,38,137,0.4)",
                      backdropFilter: "blur(12px)",
                      gap: "1rem",
                      textAlign: "center"
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "2rem" }, children: movie.emoji }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                          className: "font-serif",
...
function PassportSection() {
  const [stamped, setStamped] = reactExports.useState(false);
  const [confettiTrigger, setConfettiTrigger] = reactExports.useState(0);
  const handleStamp = () => {
    setStamped(true);
    setConfettiTrigger((c) => c + 1);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "Twin Friendship Passport 🛂"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: { color: "#C7B6FF", fontStyle: "italic", marginBottom: "3rem" },
            children: "official documentation of twin-certified chaos"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              boxShadow: "0 0 40px rgba(3,81,163,0.3), 0 0 80px rgba(238,38,137,0.15)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "left" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "Twin Certified Document"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                          ...
                          children: "Friendship Passport"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(199,182,255,0.6)", fontSize: "0.8rem" }, children: "Level 18 Edition" })
                    ] })
                  ]
                }
              ),
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: DETAILS.map(([key, val]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "2rem" }, children: [
                      ...
                      STATS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "0.7rem" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: STAMPS.map((stamp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            style: {
                    ...
                    !stamped ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        onClick: handleStamp,
                        ...
                        children: "Stamp Passport → FOREVER TWIN"
                      }
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "Valid for lifetime friendship."
                        }
                      )
                    ] })
                  ]
...
const CARDS = [
  {
    ...
    icon: "🌀",
    title: "Chaos Twin",
    message: "you arrived in full chaos, had no idea wtf was gonna happen later on but it was fun and chaotic to chat with u especially the TND game we used to play"
  },
  {
    id: "present",
    label: "Present",
    ...
    message: "with time u turned into a friend i trust a lot, my topmost reel contender, twin, hg, story song guide, bully 24/7 gaslighter and most imp of all my sweet lil whimsical twin"
  },
  {
    id: "future",
    label: "Future",
    icon: "🔮",
    title: "Witch Era",
    message: "not sure what's gonna happen later on but i hope to see you on top in every field u try and be bold and brave af"
  }
];
function TarotSection({ onSecretFound }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3.5rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              children: "✨ Your Cards, Twin ✨"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#C7B6FF", fontStyle: "italic" }, children: "Tap each card to reveal your reading" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
                ...
                front: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      justifyContent: "space-between",
                      padding: "1.5rem 1rem",
                      background: "linear-gradient(160deg, rgba(3,81,163,0.4), rgba(58,42,138,0.5))",
                ...
                back: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      justifyContent: "center",
                      padding: "1.5rem",
                      background: "linear-gradient(160deg, rgba(238,38,137,0.3), rgba(58,42,138,0.5))",
                      border: "1px solid rgba(238,38,137,0.4)",
                      gap: "1rem",
                      textAlign: "center"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "2.5rem" }, children: card.icon }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                          className: "font-serif gradient-text",
...
function TimelineSection() {
  ...
  reactExports.useEffect(() => {
      ...
      const obs = new IntersectionObserver(
        (entries) => {
          if (entries[0].isIntersecting) {
            setTimeout(() => {
              setVisible((prev) => /* @__PURE__ */ new Set([...prev, idx]));
    ...
    return () => {
      for (const o2 of observers) o2.disconnect();
    };
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "3.5rem" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#C7B6FF", fontStyle: "italic" }, children: "the official achievements of a chaos twin" })
        ] }),
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  ...
                  marginBottom: "2rem",
                  opacity: isVis ? 1 : 0,
                  animation: isVis ? `${isEven ? "slide-in-left" : "slide-in-right"} 0.7s ease-out forwards` : "none"
                },
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      borderRadius: "1rem",
                      background: "linear-gradient(135deg, rgba(3,81,163,0.25), rgba(238,38,137,0.15))",
                      border: "1px solid rgba(199,182,255,0.3)",
                      display: "flex",
                      alignItems: "center",
                      gap: "0.8rem"
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.5rem", flexShrink: 0 }, children: item.icon }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          style: {
...
const BG_SPARKLES = [
  ...
  { id: "bgs-11", sym: "⭐", left: 38, top: 5, fs: 0.6, dd: 2.5, dr: 2 },
  ...
  { id: "bgs-15", sym: "✨", left: 82, top: 45, fs: 0.6, dd: 2, dr: 1.9 },
  ...
  { id: "bgs-19", sym: "💫", left: 91, top: 12, fs: 0.6, dd: 2.3, dr: 2 }
];
function App() {
  const [showContent, setShowContent] = reactExports.useState(false);
  const [secretsFound, setSecretsFound] = reactExports.useState(/* @__PURE__ */ new Set());
  const [allSecretsModal, setAllSecretsModal] = reactExports.useState(false);
  const [confettiTrigger, setConfettiTrigger] = reactExports.useState(0);
  const handleSecretFound = (id) => {
    if (secretsFound.has(id)) return;
    const next = /* @__PURE__ */ new Set([...secretsFound, id]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        minHeight: "100vh",
        background: "linear-gradient(160deg, #0351A3 0%, #3a2a8a 30%, #7a1a6a 60%, #EE2689 100%)",
        backgroundAttachment: "fixed"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SparkleTrail, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "bottom-center" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Confetti, { trigger: confettiTrigger, count: 80 }),
        !showContent && /* @__PURE__ */ jsxRuntimeExports.jsx(
          LandingSection,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: BG_SPARKLES.map((sp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "animate-twinkle",
                      style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", zIndex: 1 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: "4rem" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TarotSection, { onSecretFound: handleSecretFound }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FriendshipTarot, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(LetterSection, { onSecretFound: handleSecretFound }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CrystalBallSection, { onSecretFound: handleSecretFound }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(MovieSection, { onSecretFound: handleSecretFound }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChaiSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(PassportSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TimelineSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider", style: { margin: "2rem auto" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FinalEnding, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "footer",
                  {
                    style: {
                    ...
                    children: [
                      ...
                      secretsFound.size > 0 && secretsFound.size < 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                          style: {
                            color: "rgba(199,182,255,0.5)",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "Built with sleepless boredom nights and questionable decisions."
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "by your twin"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "rgba(199,182,255,0.35)", fontSize: "0.75rem" }, children: [
                        "© ",
        ...
        allSecretsModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "fixed",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  ...
                  textAlign: "center",
                  backdropFilter: "blur(20px)",
                  boxShadow: "0 0 60px rgba(238,38,137,0.4), 0 0 100px rgba(3,81,163,0.2)"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "3rem", marginBottom: "1rem" }, children: "💫" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                      ...
                      children: "100% Twin Bond Achieved"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "you found all the secret twin lore ✨"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
...
Service({
  "getVisitCount": Func([], [Nat], []),
  "incrementVisitCount": Func([], [Nat], []),
  "isFriendshipPassportStamped": Func([], [Bool], []),
  "stampFriendshipPassport": Func([], [], [])
});
