...
export class Backend implements backendInterface {
    ...
    async incrementVisitCount(): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async isFriendshipPassportStamped(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isFriendshipPassportStamped();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async stampFriendshipPassport(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.stampFriendshipPassport();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
